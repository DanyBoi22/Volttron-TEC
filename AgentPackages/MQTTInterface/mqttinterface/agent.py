...
# -------------- Message processing --------------
    ...
    def _prepare_mqtt_payload(self, value, timestamp):
        ...
        # Optional add timestamp of the plattform timestamp
        ...
        # TODO: publishing 
            try:
                ...
                if result.rc != mqtt.MQTT_ERR_SUCCESS:
                    ...
                    _log.debug(f"Outgoing MQTT message {topic}, result {result}")
...
# -------------- MQTT Callbacks --------------
    ...
    def _on_disconnect(self, client, userdata, flags, rc, properties):
        ...
        """
        _log.info(f"Disconnected from MQTT broker. FLags: {flags}, Reason: {rc}, properties: {properties}, userdata {userdata}")
